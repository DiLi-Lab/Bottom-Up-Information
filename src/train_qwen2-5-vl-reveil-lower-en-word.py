...
IMAGE_DIR = "/swdata/yin/Cui/Re-Veil/create-dataset-new/dataset_en/en_word_lower_20250513/images"
...
config = {
    ...
    "result_path": "models/qwen2.5-7b-instruct-reveil-en-word-lower"
}
...
train_dataset = JSONLDataset("/swdata/yin/Cui/EM/reveil/data/en/en-word/lower/img_dict_train.json", IMAGE_DIR)
valid_dataset = JSONLDataset("/swdata/yin/Cui/EM/reveil/data/en/en-word/lower/img_dict_val.json", IMAGE_DIR)
